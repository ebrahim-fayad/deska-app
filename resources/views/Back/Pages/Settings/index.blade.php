@extends('Back.layouts.master',['title' => __('keyWords.settings')])
@section('content')
                ...
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.settings.update', ['setting' => $setting]) }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <x-form-label field="logo"></x-form-label>
                                    <input type="text" name="logo" class="form-control"
                                        placeholder="{{ __('keywords.logo') }}" value="{{ $setting->logo }}">
                                    <x-validation-error field="logo"></x-validation-error>
                                </div>
                                <div class="col-md-6">
                                    <x-form-label field="icon"></x-form-label>
                                    <input type="text" name="icon" class="form-control"
                                        placeholder="{{ __('keywords.icon') }}" value="{{ $setting->icon }}">
